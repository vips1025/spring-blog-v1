...
insert into board_tb(title, content, user_id, created_at)
values ('제목5', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목6', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목7', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목8', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목9', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목10', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목11', '내용4', 2, now());
insert into board_tb(title, content, user_id, created_at)
values ('제목12', '내용4', 2, now());
